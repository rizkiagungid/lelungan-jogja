...
class Booking extends CI_Controller
{
	...
	public function index()
	{
		...
		if ($dtb < 1) {
			...
			$data['temp'] = $this->db->query("select image, judul_buku, penulis, harga_buku, tiket, total_harga, tgl_booking, penerbit, tahun_terbit,id_buku from temp where id_user='$id_user'")->result_array();
		}
	...
	public function tambahBooking()
	{
		...
		$urlTotalHarga = $this->uri->segment(5);
		$jumlahTiket = $this->uri->segment(4);
	...
	public function info()
	{
		...
		$data['items'] = $this->db->query("select*from booking bo, tiket, booking_detail d, buku bu where d.id_booking=bo.id_booking and d.id_buku=bu.id and bo.id_user='$where'")->result_array();
		$this->load->view('templates/templates-user/header', $data);
